             ...
             <div class="col-lg-12">
                 ...
                 <div class="card">
                     <div class="card-image">
                         <img class="img-fluid" src="frontend/images/description-1.png" alt="alternative">
                     </div>
                     <div class="card-body">
                 ...
                 <div class="card">
                     <div class="card-image">
                         <img class="img-fluid" src="frontend/images/description-2.png" alt="alternative">
                     </div>
                     <div class="card-body">
                 ...
                 <div class="card">
                     <div class="card-image">
                         <img class="img-fluid" src="frontend/images/description-3.png" alt="alternative">
                     </div>
                     <div class="card-body">
