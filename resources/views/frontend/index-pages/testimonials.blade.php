                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="image-wrapper">
                                    <img class="img-fluid" src="frontend/images/testimonial-1.jpg"
                                        alt="alternative">
                                </div>
                                ...
                                <div class="text-wrapper">
                                    <div class="testimonial-text">I started to use Tivo with the free trial about a
                                        ...
                                        research
                                        and design. I love it and recommend it to everyone.</div>
                            ...
                            <div class="swiper-slide">
                                <div class="image-wrapper">
                                    <img class="img-fluid" src="frontend/images/testimonial-2.jpg"
                                        alt="alternative">
                                </div>
                                <!-- end of image-wrapper -->
                                <div class="text-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="image-wrapper">
                                    <img class="img-fluid" src="frontend/images/testimonial-3.jpg"
                                        alt="alternative">
                                </div>
                                <!-- end of image-wrapper -->
                                <div class="text-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="image-wrapper">
                                    <img class="img-fluid" src="frontend/images/testimonial-4.jpg"
                                        alt="alternative">
                                </div>
                                <!-- end of image-wrapper -->
                                <div class="text-wrapper">
