                    ...
                    <ul class="list-unstyled li-space-lg p-small">
                        <li class="media">
                            ...
                            <div class="media-body">Our business partners <a class="white"
                                    href="#your-link">fabievents.com</a></div>
                        </li>
                        <li class="media">
                            <i class="fas fa-square"></i>
                ...
                <div class="footer-col last">
                    ...
                    <ul class="list-unstyled li-space-lg p-small">
                        <li class="media">
                            ...
                            <div class="media-body">Chang'ombe, Tabata, Dar es salaam, Tanzania</div>
                        </li>
                        <li class="media">
                            <i class="fas fa-envelope"></i>
                            <div class="media-body"><a class="white"
                                    href="mailto:contact@tivo.com">contact@ikoteck.com</a> <i
                                    class="fas fa-globe"></i><a class="white"
                                    href="#your-link">www.ikoteck.com</a></div>
                        </li>
                    </ul>
                </div>
            </div>
